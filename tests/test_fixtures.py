...
from openruntime.core.managers import AIAgentManager, GPURuntimeManager
from openruntime.core.models import AgentRole, DeviceType, GPUDevice
...
def create_mock_runtime_manager():
    ...
    async def mock_execute_ai_task(request):
        return {"result": "Mock AI response for testing", "tokens_used": 100}
