...
class TestGPURuntimeManager:
    ...
    async def test_execute_inference_task(self):
        ...
        task = TaskRequest(operation="inference", data={"model": "resnet50", "batch_size": 1})
    ...
    async def test_execute_benchmark_task(self):
        ...
        task = TaskRequest(operation="benchmark", data={"type": "comprehensive"})
    ...
    async def test_invalid_operation(self):
        ...
        task = TaskRequest(operation="invalid_operation", data={})
...
class TestDataModels:
    ...
    def test_task_request(self):
        ...
        task = TaskRequest(
            operation="compute", data={"size": 1024}, device_preference=DeviceType.CPU, priority=5
        )
...
class TestErrorHandling:
    ...
    async def test_large_matrix_handling(self):
        ...
        task = TaskRequest(
            operation="compute", data={"type": "matrix_multiply", "size": 10000}  # Very large
        )
    ...
    async def test_invalid_matrix_size(self):
        ...
        task = TaskRequest(
            operation="compute", data={"type": "matrix_multiply", "size": -1}  # Invalid size
        )
    ...
    async def test_concurrent_task_execution(self):
        ...
        responses = await asyncio.gather(*[self.gpu_manager.execute_task(task) for task in tasks])
...
class TestPerformance:
    ...
    async def test_matrix_multiply_performance(self):
        ...
        for size in sizes:
            task = TaskRequest(operation="compute", data={"type": "matrix_multiply", "size": size})
    ...
    async def test_inference_performance(self):
        ...
        for model in models:
            task = TaskRequest(operation="inference", data={"model": model, "batch_size": 1})
