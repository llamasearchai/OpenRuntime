...
from openruntime.core.models import GPUDevice, TaskRequest
...
class TestErrorHandling:
    ...
    def test_task_with_invalid_operation(self, client):
        ...
        task_data = {"operation": "invalid_operation", "data": {}}
    ...
    def test_concurrent_task_limit(self, client):
        ...
        tasks = []
        for i in range(20):
            task_data = {"operation": "compute", "parameters": {"size": 1000, "iterations": 100}}
    ...
    def test_extremely_long_running_task(self, client):
        ...
        task_data = {
            "operation": "compute",
            "parameters": {"size": 10000, "iterations": 1000000},  # Would take very long
        }
