...
class PerformanceReporter:
    ...
    def generate_plots(self):
        ...
        if "stress_test" in self.report_data:
            ...
            response_times = [self.report_data["stress_test"]["endpoints"][ep].get("avg_response_time", 0) for ep in endpoints]
        ...
        if "stress_test" in self.report_data:
            throughputs = [self.report_data["stress_test"]["endpoints"][ep].get("throughput", 0) for ep in endpoints]
...
"""
    ...
    def _generate_summary_section(self) -> str:
        ...
        if "stress_test" in self.report_data:
            ...
            avg_response_time = (
                sum(ep.get("avg_response_time", 0) for ep in endpoints.values()) / len(endpoints) if endpoints else 0
            )
    ...
    def save_current_results(self):
        ...
        current_data = {
            ...
            "avg_response_time": sum(
                ep.get("avg_response_time", 0) for ep in self.report_data["stress_test"]["endpoints"].values()
            )
            / len(self.report_data["stress_test"]["endpoints"]),
            "avg_throughput": sum(ep.get("throughput", 0) for ep in self.report_data["stress_test"]["endpoints"].values())
            / len(self.report_data["stress_test"]["endpoints"]),
        }
