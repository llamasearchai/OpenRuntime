...
class RuntimeEngine:
    ...
    async def submit_task(
        self, task_type: TaskType, payload: Dict[str, Any], backend: Optional[RuntimeBackend] = None
    ) -> str:
    ...
    async def _execute_task(self, task_data: Dict[str, Any]) -> TaskResult:
        ...
        try:
            ...
            task_result = TaskResult(
                ...
                status="completed",
                result=result,
                metrics={"duration_ms": duration_ms, "backend": backend_name},
    ...
    def _select_backend(
        self, task_type: TaskType, preferred: Optional[RuntimeBackend] = None
    ) -> Any:
