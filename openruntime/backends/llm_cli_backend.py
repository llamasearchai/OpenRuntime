...
class LLMCLIBackend(BaseBackend):
    ...
    async def _discover_models(self) -> None:
        ...
        try:
            ...
            # Ollama models
            ollama_result = await self._run_command(["llm", "models", "list", "--plugin", "llm-ollama"])
    ...
    async def _run_command(self, cmd: List[str], input_text: Optional[str] = None) -> Dict[str, Any]:
